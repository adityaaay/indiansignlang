...
while True:
    ...
    # display count of each set on screen
    ...
    # bounding box
    cv2.rectangle(img, (219, 9), (621, 419), (255, 0, 0), 1)
    RegionOfInterest = img[10:410, 220:520]
    cv2.imshow("image", img)

    # applying the filters to the hand image
    ...
    RegionOfInterest = cv2.resize(RegionOfInterest, (300, 300))
