...
class Application:
    def __init__(self):
        ...
        self.T.config(text="Sign Language to Text Conversion in Real Time \n using Machine Learning", font=("courier", 20, "bold"))
    ...
    def action_call(self):
        ...
        self.tx.place(x=10, y=20)
        self.tx.config(text="Efforts By - \n"
                            "Aditya Sharma - RA1711003030295 \n"
                            "Yash Narang - RA1711003030263 \n "
                            "Under the Supervision of \n"
                            "Mr. Devesh Kumar Sharma \n", fg="blue", font=("Courier", 15, "bold"))

        '''self.img1 = ImageTk.PhotoImage(Image.open("aditya.png"))
        self.w1.place(x=10, y=40)
        self.w1 = tk.Label(self.root1, image=ImageTk.PhotoImage(Image.open("aditya.png")))
        self.tx6 = tk.Label(self.root1)
        self.tx6.place(x=10, y=50)
        self.tx6.config(text="Aditya\nRA1711003030295", font=("Courier", 15, "bold"))

        self.photo2 = ImageTk.PhotoImage(file='Pictures/yash.png')
        ...
        self.photo6 = tk.PhotoImage(file='Pictures/srm.png')
        self.w6 = tk.Label(self.root1, image=self.photo6)
        self.w6.place(x=350, y=420)
        self.tx6 = tk.Label(self.root1)
        self.tx6.place(x=230, y=670)
        self.tx6.config(text="Mr. Devesh Kumar Sharma", font=("Courier", 30, "bold"))'''
